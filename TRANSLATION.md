# 🌍 Translation Guide for WebistzuPDF

This guide will help you add new languages or improve existing translations for WebistzuPDF.
...
WebistzuPDF uses **i18next** for internationalization (i18n). Currently supported languages:
...
WebistzuPDF is **friendly, clear, and professional**. Match this tone in your translations.
...
```json
{
  "faq.analytics.answer": "We care about your privacy. WebistzuPDF does not track personal information. We use <a href=\"https://simpleanalytics.com\" class=\"text-indigo-400 hover:underline\" target=\"_blank\" rel=\"noopener noreferrer\">Simple Analytics</a> solely to see anonymous visit counts."
}
```
...
```json
{
  "faq.analytics.answer": "Wir schätzen Ihre Privatsphäre. WebistzuPDF verfolgt keine persönlichen Informationen. Wir verwenden <a href=\"https://simpleanalytics.com\" class=\"text-indigo-400 hover:underline\" target=\"_blank\" rel=\"noopener noreferrer\">Simple Analytics</a> ausschließlich, um anonyme Besucherzahlen zu sehen."
}
```
...
2. Open an issue on [GitHub](https://github.com/Zara-Datacenter/webistzupdf/issues)
...
Thank you for contributing to WebistzuPDF! 🎉
