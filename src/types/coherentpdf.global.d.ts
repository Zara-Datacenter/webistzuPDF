/*
 * coherentpdf.global.d.ts — TypeScript type definitions for WebistzuPDF / CoherentPDF integration
 *
 * These type definitions were written by Alam for use in the WebistzuPDF project.
