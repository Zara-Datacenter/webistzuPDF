...
[Hostinger](https://hostinger.com) is a popular shared hosting provider. This guide covers deploying WebistzuPDF to Hostinger's shared hosting.
...
# ============================================
# Canonical WWW
RewriteCond %{HTTP_HOST} ^pdf\.webistzu\.com [NC]
RewriteRule ^(.*)$ https://pdf.webistzu.com/$1 [L,R=301]
