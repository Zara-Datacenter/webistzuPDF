...
WebistzuPDF can be self-hosted on your own infrastructure. This guide covers various deployment options.

## Quick Start with Docker

The fastest way to self-host WebistzuPDF:
...
See [SIMPLE_MODE.md](https://github.com/Zara-Datacenter/webistzupdf/blob/main/SIMPLE_MODE.md) for full details.
...
::: tip
WebistzuPDF is a static site—there's no database or backend server required!
:::
