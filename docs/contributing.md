...
Thank you for your interest in contributing to WebistzuPDF! This guide will help you get started.
...
git clone https://github.com/YOUR_USERNAME/webistzupdf.git
cd webistzupdf
...
See [TRANSLATION.md](https://github.com/Zara-Datacenter/webistzupdf/blob/main/TRANSLATION.md) for adding new languages.

## Contributor License Agreement

Before your PR can be merged, you'll need to sign our CLA:

- [Individual CLA (ICLA)](https://github.com/Zara-Datacenter/webistzupdf/blob/main/ICLA.md)
- [Corporate CLA (CCLA)](https://github.com/Zara-Datacenter/webistzupdf/blob/main/CCLA.md)

## Getting Help

- [GitHub Issues](https://github.com/Zara-Datacenter/webistzupdf/issues)
- [Discord Community](https://discord.gg/Bgq3Ay3f2w)

## License

WebistzuPDF is licensed under **MIT**. By contributing, you agree that your contributions will be licensed under the same terms.
